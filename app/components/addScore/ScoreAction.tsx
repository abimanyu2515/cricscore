...
const ScoreAction = ({onCancel}: ScoreActionProps) => {
  return (
    <div className="grid grid-cols-2 mt-8 gap-3">
        ...
        <button className="font-mono font-semibold text-sm text-black bg-cyan-400 hover:bg-[#cdeb6b] hover:shadow hover:shadow-[#b9e03c] rounded-md cursor-pointer">SAVE SCORE</button>
    </div>
  )
}
