const AddPlayerCard = ({ onClick }: { onClick: () => void }) => {
  return (
      <div onClick={onClick} className="bg-[#111c2e] border border-dashed border-zinc-700 hover:border-cyan-400 active:border-cyan-400 pb-1 cursor-pointer rounded-lg">
